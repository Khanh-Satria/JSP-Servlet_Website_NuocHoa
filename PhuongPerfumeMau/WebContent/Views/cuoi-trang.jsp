            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <form action="DangNhapServlet" method="post" name="frmDangNhap">
                        	<input type="text" name="txtEmail" value="" style="margin-bottom:10px" placeholder="Nhập Email"/>
                        	<input type="password" name="txtPassword" value="" style="margin-bottom:10px" placeholder="Nhập Password"/>
